      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="userrecord.jsp">View User Record</a></li>
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="userupdate.jsp">Update User Record</a></li>
            <li><a class="dropdown-item" href="deleteu.jsp">Delete User Record</a></li>
          </ul>
        </li>
